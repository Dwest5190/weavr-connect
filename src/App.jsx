...
function AppMain(){
  ...
  return <div style={{display:"flex",height:"100vh",fontFamily:"'DM Sans',sans-serif",background:"var(--bg)",color:"var(--text)",...cssVars}}>
    ...
    <main style={{flex:1,overflowY:"auto",minHeight:"100vh"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 32px",borderBottom:"1px solid var(--divider)",marginBottom:24,position:"sticky",top:0,background:isDark?cw.darkSolid+"E8":"rgba(240,242,245,0.92)",zIndex:50,backdropFilter:"blur(8px)"}}>
...
export default function App(){
  ...
  return <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"linear-gradient(145deg,#312E81,#1E1B4B 60%,#0F172A)",fontFamily:"'DM Sans',sans-serif"}}>
    <style>{"@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600;700;800&family=Nunito:wght@700;800;900&display=swap');"}</style>
