...
function Overview(p){
  ...
  return <div>
    <div style={{background:"var(--hero)",borderRadius:24,padding:"32px 36px",marginBottom:28,position:"relative",overflow:"hidden"}}>
    ...
    <Reveal open={showWidgetPicker}><div style={{background:"var(--card)",borderRadius:22,padding:"24px 28px",marginBottom:24,boxShadow:"var(--card-shadow)",border:"1px solid var(--divider)"}}>
      ...
      <div className="weavr-widget-picker" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8}}>
...
function PeopleView(p){
  ...
  return <div>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
      <div><h2 style={{fontSize:22,fontWeight:800,color:"var(--text)",display:"flex",alignItems:"center",gap:10}}>{stObj&&<Dot color={stObj.color} sz={10}/>}{stObj?stObj.label:"All People"}</h2><p style={{fontSize:12,color:"var(--text-muted)",marginTop:3}}>{fil.length} people</p></div>
...
function AssignedCards(p){
  ...
  return <div>
    <div className="weavr-ac-header" style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
      <div><h2 style={{fontSize:22,fontWeight:800,color:"var(--text)",display:"flex",alignItems:"center",gap:10}}><I n="card" sz={22} c="var(--primary)"/>Assigned Cards</h2><p style={{fontSize:12,color:"var(--text-muted)",marginTop:3}}>View and work contacts by team member</p></div>
      <div style={{display:"flex",gap:6}}>
...
function Panel(p){
  ...
  return <div style={{position:"fixed",inset:0,background:"rgba(15,23,42,0.5)",zIndex:200,display:"flex",justifyContent:"flex-end"}} onClick={p.onClose}><div className="weavr-panel" style={{width:560,maxWidth:"100vw",height:"100vh",background:"var(--card-solid)",display:"flex",flexDirection:"column",animation:"panelSlide 0.4s cubic-bezier(0.22,1,0.36,1)",overflowY:"auto",boxShadow:"-12px 0 48px rgba(0,0,0,0.12)"}} onClick={function(e){e.stopPropagation()}}>
    <div style={{padding:"24px 24px 20px",background:"var(--hero)",position:"relative"}}>
      <button style={{position:"absolute",top:16,right:16,background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:10,width:32,height:32,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2,backdropFilter:"blur(4px)"}} onClick={p.onClose}><I n="x" sz={14} c="rgba(255,255,255,0.7)"/></button>
    ...
    <div style={{padding:"12px 24px",borderBottom:"1px solid var(--divider)",background:"var(--card-solid)",position:"sticky",top:0,zIndex:10}}>
...
function AppMain(p){
  ...
  return <div style={{display:"flex",height:"100vh",fontFamily:"'Nunito',sans-serif",background:"var(--bg)",color:"var(--text)",...cssVars}}>
    <style>{["@import url('https://fonts.googleapis.com/css2?family=Nunito:wght@300;400;500;600;700;800;900&display=swap');","*,*::before,*::after{box-sizing:border-box;margin:0;padding:0;font-family:'Nunito',sans-serif !important}","::-webkit-scrollbar{width:5px}::-webkit-scrollbar-thumb{background:#64748B;border-radius:3px}","@keyframes slideIn{from{transform:translateX(100%);opacity:0}to{transform:translateX(0);opacity:1}}","@keyframes panelSlide{from{transform:translateX(100%)}to{transform:translateX(0)}}","@keyframes fadeUp{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:translateY(0)}}","@keyframes revealDown{from{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:translateY(0)}}","@keyframes revealUp{from{opacity:1;transform:translateY(0)}to{opacity:0;transform:translateY(-12px)}}","@keyframes gentleFade{from{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}","@keyframes pulse{0%{transform:scale(1)}50%{transform:scale(1.08)}100%{transform:scale(1)}}","@keyframes shimmer{0%{background-position:-200% 0}100%{background-position:200% 0}}","@keyframes confettiFall{0%{transform:translateY(-10px) rotate(0deg);opacity:1}100%{transform:translateY(60px) rotate(360deg);opacity:0}}",".score-ring-pulse{animation:pulse 2s ease-in-out infinite}",".shimmer-btn{background-size:200% 100%;animation:shimmer 2s ease infinite}","input:focus,textarea:focus,select:focus{outline:none;border-color:var(--primary) !important;box-shadow:0 0 0 3px var(--primary)20 !important}","button{cursor:pointer;font-family:'Nunito',sans-serif !important}button:active{transform:scale(0.97)}","@media(max-width:768px){.weavr-sidebar{display:none !important}.weavr-mobile-nav{display:flex !important}.weavr-main-header{padding:10px 14px !important;gap:6px !important}.weavr-main-content{padding:0 16px 100px !important}.weavr-pipeline-grid{grid-template-columns:repeat(3,1fr) !important;gap:6px !important}.weavr-pipeline-grid>div{padding:10px 6px !important}.weavr-kpi-grid{grid-template-columns:repeat(2,1fr) !important}.weavr-card-grid{grid-template-columns:1fr !important}.weavr-panel{width:100vw !important;max-width:100vw !important;border-radius:0 !important}.weavr-qe-layout{flex-direction:column !important}.weavr-qe-recent{width:100% !important}.weavr-next-up{flex-direction:column !important}.weavr-next-up>div:last-child{flex-direction:row !important;width:100% !important}.weavr-ws-grid{grid-template-columns:repeat(2,1fr) !important}.weavr-ws-input{grid-template-columns:repeat(2,1fr) !important}.weavr-widget-picker{grid-template-columns:repeat(2,1fr) !important}.weavr-sort-wrap{overflow-x:auto;-webkit-overflow-scrolling:touch;flex-wrap:nowrap !important}.weavr-ac-header{flex-direction:column !important;align-items:flex-start !important;gap:10px !important}.weavr-ac-teams{overflow-x:auto !important;-webkit-overflow-scrolling:touch !important;flex-wrap:nowrap !important;padding-bottom:4px}.weavr-fc-header{flex-direction:column !important;align-items:flex-start !important;gap:8px !important}table{display:block;overflow-x:auto;white-space:nowrap;-webkit-overflow-scrolling:touch}h2{font-size:18px !important}h3{font-size:14px !important}select{max-width:140px !important}.weavr-stats-compare{flex-direction:column !important;align-items:flex-start !important;gap:6px !important}}","@media(max-width:480px){.weavr-pipeline-grid{grid-template-columns:repeat(2,1fr) !important}.weavr-kpi-grid{grid-template-columns:1fr !important}.weavr-main-header{flex-wrap:wrap !important;gap:8px !important}.weavr-ws-grid{grid-template-columns:1fr 1fr !important}.weavr-ws-input{grid-template-columns:1fr 1fr !important}}"].join("\n")}</style>
    <aside className="weavr-sidebar" style={{width:260,background:"var(--sidebar)",display:"flex",flexDirection:"column",flexShrink:0,height:"100vh",position:"sticky",top:0,boxShadow:"4px 0 20px rgba(0,0,0,0.06)"}}>
      <div style={{display:"flex",alignItems:"center",gap:14,padding:"22px 18px",borderBottom:"1px solid rgba(255,255,255,0.06)"}}>
        <button onClick={p.onBackToPortal} style={{width:26,height:26,borderRadius:8,background:"var(--sb-active)",border:"none",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0}} title="Back to Portal"><I n="back" sz={13} c="var(--sb-muted)"/></button>
        ...
        <div><div style={{fontSize:16,fontWeight:800,color:"var(--sb-text)",lineHeight:1.2,letterSpacing:"0.14em",fontFamily:"'Nunito',sans-serif"}}>WEAVR</div><div style={{fontSize:10,fontWeight:500,color:"var(--sb-muted)",letterSpacing:"0.04em"}}>Bethany Church</div></div>
      </div>
      <nav style={{flex:1,padding:"14px 16px",overflowY:"auto"}}>{sideItems.map(function(item,i){if(item.type==="divider")return <div key={"d"+i} style={{height:1,background:"var(--sb-divider)",margin:"10px 14px"}}/>;var active=activeKey===item.key;return <button key={item.key} onClick={function(){nav(item.vw,item.sf)}} style={{display:"flex",alignItems:"center",gap:12,width:"100%",padding:"11px 14px",borderRadius:12,border:"none",fontSize:13,fontWeight:active?600:500,background:active?"var(--sb-active)":"transparent",color:active?"var(--sb-text)":"var(--sb-muted)",textAlign:"left",marginBottom:2,transition:"all 0.15s"}}>{item.icon?<I n={item.icon} sz={16} c={active?"var(--sb-text)":"var(--sb-muted)"}/>:<span style={{width:8,height:8,borderRadius:"50%",background:item.color,display:"inline-block"}}/>}<span style={{flex:1}}>{item.label}</span>{item.color&&<span style={{fontSize:10,fontWeight:600,color:"var(--sb-muted)",opacity:0.7}}>{countForStage(item.key)}</span>}</button>})}</nav>
      <div style={{padding:"12px"}}>
        <button style={{width:"100%",padding:"11px 14px",borderRadius:12,border:"none",background:"var(--sb-active)",color:"var(--sb-text)",fontSize:12,fontWeight:600,display:"flex",alignItems:"center",justifyContent:"center",gap:6}} onClick={function(){setAdd(true)}}><I n="plus" sz={14} c="var(--sb-text)"/>Add Person</button>
        <div style={{marginTop:10,padding:"10px 12px",background:"var(--sb-active)",borderRadius:10,display:"flex",justifyContent:"space-between"}}>
          <div style={{textAlign:"center"}}><div style={{fontSize:14,fontWeight:700,color:"var(--sb-muted)"}}>{people.length}</div><div style={{fontSize:9,color:"var(--sb-muted)",fontWeight:600,opacity:0.6}}>Tracked</div></div>
          <div style={{textAlign:"center"}}><div style={{fontSize:14,fontWeight:700,color:"#F59E0B"}}>{people.filter(function(x){return x.fullyConnected}).length}</div><div style={{fontSize:9,color:"var(--sb-muted)",fontWeight:600,opacity:0.6}}>Connected</div></div>
          <div style={{textAlign:"center"}}><div style={{fontSize:14,fontWeight:700,color:"#EF4444"}}>{people.filter(function(x){return!x.fullyConnected&&(ago(x.lastContactDate)===null||ago(x.lastContactDate)>3)}).length}</div><div style={{fontSize:9,color:"var(--sb-muted)",fontWeight:600,opacity:0.6}}>Overdue</div></div>
        </div>
      </div>
    </aside>
...
export default function App(){
  ...
  return <div style={{position:"relative",minHeight:"100vh",fontFamily:"'Nunito',sans-serif",background:"#1E1B4B"}}>
    ...
    {!authed&&<div style={{position:"fixed",inset:0,display:"flex",alignItems:"center",justifyContent:"center",zIndex:300,background:"rgba(15,23,42,0.3)"}}>
      <div style={{width:420,maxWidth:"92vw",animation:authAnim?"authFadeOut 0.6s ease forwards":"authFadeIn 0.5s ease"}}>
        <div style={{textAlign:"center",marginBottom:32}}>
          <div style={{width:64,height:64,borderRadius:22,background:"linear-gradient(135deg,#7C3AED,#06B6D4)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 16px",boxShadow:"0 12px 40px rgba(124,58,237,0.35)"}}><WeavrLogo sz={34}/></div>
