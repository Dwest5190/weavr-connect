...
var openUrl=function(url){window.location.href=url};
  ...
  return <Modal title={"Contact "+person.firstName} onClose={p.onClose}>
    {person.phone&&<div style={{marginBottom:16}}>
      ...
      <div style={{display:"flex",gap:6,marginTop:8}}>
        <a href={smsUrl(person.phone,msg)} style={{flex:1,textDecoration:"none",padding:"10px",borderRadius:10,background:"#06B6D410",border:"1px solid #06B6D425",textAlign:"center",fontSize:12,fontWeight:600,color:"#06B6D4",display:"block"}}>Open in Messages</a>
        <a href={telUrl(person.phone)} style={{flex:1,textDecoration:"none",padding:"10px",borderRadius:10,background:"var(--primary)10",border:"1px solid var(--primary)25",textAlign:"center",fontSize:12,fontWeight:600,color:"var(--primary)",display:"block"}}>Call</a>
      </div>
    </div>}
    ...
    {person.email&&<div>
      ...
      <div style={{display:"flex",gap:6}}>
        <a href={mailUrl(person.email,em.subj||"",em.body||"")} style={{flex:1,textDecoration:"none",padding:"10px",borderRadius:10,background:"#10B98110",border:"1px solid #10B98125",textAlign:"center",fontSize:12,fontWeight:600,color:"#10B981",display:"block"}}>Open in Mail</a>
      ...
      <div style={{maxHeight:500,overflowY:"auto"}}>{msgs.map(function(m,i){return <div key={m.person.id} style={{padding:"14px 0",borderTop:i>0?"1px solid var(--divider)":"none"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
          ...
          <div style={{display:"flex",gap:6}}>
            ...
            <a href={smsUrl(m.person.phone,m.text)} style={{textDecoration:"none",padding:"4px 10px",borderRadius:8,background:"linear-gradient(135deg,#67E8F9,#06B6D4)",color:"#fff",fontSize:11,fontWeight:600,display:"inline-flex",alignItems:"center",gap:4}}><I n="send" sz={11} c="#fff"/>SMS</a>
          </div>
        </div>
