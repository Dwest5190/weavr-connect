...
function SortBar(p){return <div className="weavr-sort-wrap" style={{display:"flex",gap:4,flexWrap:"wrap"}}>{(p.opts||SORT_OPTS).map(function(o){var active=p.value===o.key;return <button key={o.key} onClick={function(){p.onChange(active?"newest":o.key)}} style={{padding:"5px 10px",borderRadius:8,border:active?"1px solid var(--primary)":"1px solid var(--inp-border)",background:active?"var(--primary)08":"var(--inp)",fontSize:10,fontWeight:active?700:500,color:active?"var(--primary)":"var(--text-muted)",cursor:"pointer",transition:"all 0.15s"}}>{o.label}</button>})}</div>}
...
function Overview(p){
  ...
  var renderWidget=function(key){
    if(key==="next-up"){var top1=mml[0];if(!top1)return null;var stg=STAGES.find(function(s){return s.key===top1.currentStage});var d=ago(top1.lastContactDate);var tm=teams.find(function(t){return t.id===top1.assignedTo});return <div className="weavr-next-up" style={{display:"flex",gap:14,flexWrap:"wrap"}}>
...
function PeopleView(p){
  ...
  return <div>
    ...
    <div style={{background:"var(--card)",borderRadius:18,padding:0,overflow:"hidden",boxShadow:"var(--card-shadow)"}}>
...
function AssignedCards(p){
  ...
  return <div>
    ...
    acView==="list"?<div style={{background:"var(--card)",borderRadius:18,overflow:"hidden",boxShadow:"var(--card-shadow)"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(300px,1fr))",gap:14}}>
      {assigned.map(function(x){
        ...
        return <div key={x.id} style={{background:"var(--card)",borderRadius:16,padding:"18px 20px",cursor:"pointer",border:"1px solid "+(stg?stg.color+"35":"var(--divider)"),boxShadow:"var(--card-shadow)",transition:"all 0.2s"}} onClick={function(){p.onPerson(x)}} onMouseEnter={function(e){e.currentTarget.style.transform="translateY(-2px)";e.currentTarget.style.borderColor=stg?stg.color+"60":"var(--divider)"}} onMouseLeave={function(e){e.currentTarget.style.transform="translateY(0)";e.currentTarget.style.borderColor=stg?stg.color+"35":"var(--divider)"}}>
          ...
          {x.phone&&<div style={{fontSize:12,color:"var(--text-muted)",marginTop:8}}>{fmtPhone(x.phone)}</div>}
        </div>;
      })}
...
function QuickEntry(p){
  ...
  return <div>
    ...
    <div className="weavr-qe-layout" style={{display:"flex",gap:20,alignItems:"flex-start"}}>
      <div style={{flex:1,background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
      ...
      {recent.length>0&&<div className="weavr-qe-recent" style={{width:320,flexShrink:0}}>
        ...
        <div style={{background:"var(--card)",borderRadius:14,padding:"8px",maxHeight:500,overflowY:"auto",boxShadow:"var(--card-shadow)"}}>
...
function FullyConnected(p){
  ...
  return <div>
    ...
    {connected.length===0?<div style={{background:"var(--card)",borderRadius:18,padding:48,textAlign:"center",color:"var(--text-muted)",boxShadow:"var(--card-shadow)"}}><div style={{fontSize:15,fontWeight:600}}>No one fully connected yet</div><p style={{fontSize:12,marginTop:6}}>When someone joins both a BGroup and the ATeam, they'll appear here.</p></div>:
    fcView==="list"?<div style={{background:"var(--card)",borderRadius:18,overflow:"hidden",boxShadow:"var(--card-shadow)"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(320px,1fr))",gap:14}}>
      {connected.map(function(x){
        ...
        return <div key={x.id} style={{background:"var(--card)",borderRadius:18,padding:"20px 24px",cursor:"pointer",boxShadow:"var(--card-shadow)",border:"2px solid #F59E0B30",position:"relative",overflow:"hidden"}} onClick={function(){p.onPerson(x)}}>
...
function Settings(p){
  ...
  return <div>
    ...
    {tab==="teams"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="templates"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="email-tpl"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="sequences"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="automation"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="checkins"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="forms"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="visual"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
    ...
    {tab==="data"&&<div style={{background:"var(--card)",borderRadius:18,padding:"22px 24px",boxShadow:"var(--card-shadow)"}}>
...
function Panel(p){
  ...
  return <div style={{position:"fixed",inset:0,background:"rgba(15,23,42,0.4)",zIndex:200,display:"flex",justifyContent:"flex-end"}} onClick={p.onClose}><div className="weavr-panel" style={{width:560,maxWidth:"100vw",height:"100vh",background:"var(--card-solid)",display:"flex",flexDirection:"column",animation:"panelSlide 0.4s cubic-bezier(0.22,1,0.36,1)",overflowY:"auto",boxShadow:"-8px 0 40px rgba(0,0,0,0.15)"}} onClick={function(e){e.stopPropagation()}}>
    ...
    <div style={{padding:"16px 20px",overflowY:"auto",flex:1}}>
      ...
      <Reveal open={showCal}><div style={{background:"var(--card)",borderRadius:14,padding:"14px 18px",marginBottom:16,boxShadow:"var(--card-shadow)"}}>
      ...
      <Reveal open={showFollowUp}><div style={{marginBottom:16}}>
        <div style={{background:"var(--card)",borderRadius:14,padding:"14px 16px",border:"1px solid var(--primary)20",boxShadow:"var(--card-shadow)"}}>
      ...
      {!edit&&<div style={{marginBottom:16}}>
        ...
        <div style={{background:"var(--card)",borderRadius:14,padding:"12px 16px",display:"flex",flexDirection:"column",gap:8,boxShadow:"var(--card-shadow)"}}>
      ...
      <Reveal open={edit}><div style={{background:"var(--card)",borderRadius:14,padding:"14px 18px",marginBottom:16,boxShadow:"var(--card-shadow)"}}>
      ...
      <div style={{marginBottom:16}}>
        ...
        <div style={{background:"var(--card)",borderRadius:14,padding:"12px 16px",boxShadow:"var(--card-shadow)"}}>
...
function AppMain(p){
  ...
  return <div style={{display:"flex",height:"100vh",fontFamily:"'Nunito',sans-serif",background:"var(--bg)",color:"var(--text)",...cssVars}}>
    ...
    <aside className="weavr-sidebar" style={{width:240,background:"var(--sidebar)",display:"flex",flexDirection:"column",flexShrink:0,height:"100vh",position:"sticky",top:0,boxShadow:"4px 0 24px rgba(0,0,0,0.1)"}}>
      ...
      <nav style={{flex:1,padding:"10px 12px",overflowY:"auto"}}>{sideItems.map(function(item,i){if(item.type==="divider")return <div key={"d"+i} style={{height:1,background:"var(--sb-divider)",margin:"8px 12px"}}/>;var active=activeKey===item.key;return <button key={item.key} onClick={function(){nav(item.vw,item.sf)}} style={{display:"flex",alignItems:"center",gap:10,width:"100%",padding:"9px 12px",borderRadius:10,border:"none",fontSize:12,fontWeight:active?600:500,background:active?"var(--sb-active)":"transparent",color:active?"var(--sb-text)":"var(--sb-muted)",textAlign:"left",marginBottom:1}}>{item.icon?<I n={item.icon} sz={15} c={active?"var(--sb-text)":"var(--sb-muted)"}/>:<span style={{width:7,height:7,borderRadius:"50%",background:item.color,display:"inline-block"}}/>}<span style={{flex:1}}>{item.label}</span>{item.color&&<span style={{fontSize:10,fontWeight:600,color:"var(--sb-muted)"}}>{countForStage(item.key)}</span>}</button>})}</nav>
    ...
    <main style={{flex:1,overflowY:"auto",minHeight:"100vh"}}>
      <div className="weavr-main-header" style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 32px",borderBottom:"1px solid var(--divider)",marginBottom:24,position:"sticky",top:0,background:isDark?cw.darkSolid+"E8":"rgba(240,242,245,0.92)",zIndex:50,backdropFilter:"blur(8px)"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <button onClick={function(){var next=config.theme==="light"?"dark":config.theme==="dark"?"mono":"light";setConfig({...config,theme:next})}} style={{display:"flex",alignItems:"center",gap:6,padding:"6px 12px",borderRadius:10,border:"1px solid var(--inp-border)",background:"var(--inp)",cursor:"pointer",fontSize:11,fontWeight:600,color:"var(--text-muted)"}}><I n={config.theme==="mono"?"eye":"sun"} sz={13} c="var(--text-muted)"/>{config.theme==="light"?"Dark":config.theme==="dark"?"Simple":"Light"}</button>
